      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            {!isEditingProfile ? (
              <button
                id="cashier-settings-edit-profile-btn"
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] text-2xl font-bold text-white shadow-lg border-4 border-white flex-shrink-0">
              {getInitials(user?.username)}
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-800">{user?.username}</h3>
              <p className="text-sm text-sky-600 font-medium">Kasir</p>
            ...
            <form onSubmit={handleProfileSave} className="space-y-4 max-w-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    id="cashier-settings-username-input"
                ...
                <div>
                  ...
                  <input
                    id="cashier-settings-email-input"
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
                ...
                <input
                  id="cashier-settings-confirm-password-input"
              ...
              <button
                type="submit"
                id="cashier-settings-save-profile-btn"
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <form onSubmit={handlePasswordChange} className="max-w-xl space-y-4">
            ...
            <div className="pt-1">
              <button
                type="submit"
                id="cashier-settings-update-password-btn"
