...
const AppTitle = () => (
  <div className="text-center">
    <h1
      ...
      style={{ fontWeight: 700, letterSpacing: "-0.02em", color: colors.textWhite }}
    >
      POS <span style={{ color: colors.primary }}>System</span>
    </h1>
    <p
      className="text-sm mt-2 uppercase"
      style={{ color: colors.neutral[400], letterSpacing: "0.25em", fontWeight: 300 }}
    >
      Point of Sale
    </p>
  </div>
...
const ProgressBar = ({ progress }) => (
  <div className="mt-8 w-56">
    ...
    <p
      ...
      style={{ color: colors.neutral[600], fontWeight: 400 }}
    >
      Memuat ...
    </p>
  </div>
  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{ color: colors.neutral[600], fontWeight: 300 }}
      >
        v1.0.0
      </p>
    </div>
